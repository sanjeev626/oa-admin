        ...
        <div class="pbox" id="div1">
            <div class="border-box form-horizontal" id="medicineorder">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="sales_type" id="sales_type" value="online" checked="checked"> Online
                    <input type="radio" name="sales_type" id="sales_type" value="counter_sales" <?php if(isset($_GET['sales_type'])&& $_GET['sales_type']=="counter_sales") echo 'checked="checked"';?>> Counter Sales
                </div>
                <div class="form-group">
                    ...
                    while($rasValue = $mydb->fetch_array($result))
                    {
                        ...
                        <div class="form-group prescription" id="image_display">
                            ...
                            <label class="radio-inline">
                                ...
                                <img style="width:50px;height:60px;" src="../<?php  echo $image_path;?>/<?php echo $image_name;?>" alt="">
                            </label>
                        </div>
                    <?php }
                }else
                ...
                <div class="row">
                    <div class="col-md-1 col-sm-1 col-xs-1"><label for="sn">S.N. </label></div>
                    <div class="col-md-3 col-sm-3 col-xs-3"><label for="quantity">Quantity/No. of tablet: </label></div>
                    <div class="col-md-4 col-sm-4 col-xs-4"><label for="exampleInputEmail1">Product/Medicine Name</label></div>
                    <div class="col-md-2 col-sm-2 col-xs-2"><label for="type">Medicine Type:</label></div>
                ...
                <div id="addmedicine">
                    <div class="row">
                        <div class="col-md-1 col-sm-1 col-xs-1"><label for="number">&nbsp;</label></div>
                        <div class="col-md-3 col-sm-3 col-xs-3"><input min="1" type="number" id="quantity" name="quantity" value="1" /></div>
                        <div class="col-md-4 col-sm-4 col-xs-4"><input type="text" class="form-control" id="searchid" placeholder="Search for medicine" value="" required><div id="result"> </div></div>
                ...
                <div id="display">
                    <div class="row">
                        <div class="col-md-1 col-sm-1 col-xs-1"><label for="sn">S.N. </label></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><label for="quantity">Quantity </label></div>
                        <div class="col-md-4 col-sm-4 col-xs-4"><label for="exampleInputEmail1">Product/Medicine Name</label></div>
                        <div class="col-md-2 col-sm-1 col-xs-1 med-type"><label for="type">Medicine Type:</label></div>
                        <div class="col-md-1 col-sm-1 col-xs-1 med-type"><label for="blank">Rate</label></div>
                        <div class="col-md-1 col-sm-1 col-xs-1 med-type"><label for="blank">Total</label></div>
                    ...
                    while($order = $mydb->fetch_array($result1))
                    {
                        ...
                        {
                            $sp_per_tab = $mydb->getValue('sp_per_tab','tbl_stock','medicine_id="'.$order['medicine_id'].'" AND stock>sales ORDER BY expiry_date ASC');
                        ...
                        ?>
                        <div class="row">
                            <div class="col-md-1 col-sm-1 col-xs-1"><?php echo ++$count;?><input type="hidden" id="temp_order_id[]" name="temp_order_id[]" value="<?php echo $order['id'];?>" /></div>
                            <div class="col-md-1 col-sm-1 col-xs-1"><input min="1" type="number" id="qty[]" name="qty[]" value="<?php echo $order['quantity'];?>" style="width:50px;" /></div>
                    ...
                    ?>                    
                        <div class="row">
                            <div class="col-md-1 col-sm-1 col-xs-1"></div>
                            <div class="col-md-1 col-sm-1 col-xs-1" id="quan"><button type="submit" class="btn btn-default next" name="btnUpdate" id ="updateid" value ="Update">Update</button></div>
