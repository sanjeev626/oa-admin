...
<div class="container">
	<div class="row home">
		...
		<div class="col-md-3 client">
			<div class="parts">
				<h2 id="usercount"><?php echo $mydb->getCount('id', 'users', 'active=1'); ?></h2>
				<p>Total No.of Clients</p>
			</div>
			<div class="more">
				<a href="<?php echo SITEROOTADMIN; ?>index.php?manager=users">View Details</a>
			</div>
		</div>
		...
		<div class="col-md-3 purchase">
			<div class="parts">
				<h2 id="total_purchase"></h2>
				<p>Monthly Purchase </p>
			</div>
			<div class="more">
				<a href="<?php echo SITEROOTADMIN; ?>index.php?manager=details&action=purchase">View Details</a>
			</div>
		</div>
		<div class="col-md-3 sales">
			...
			<div class="more">
				<a href="<?php echo SITEROOTADMIN; ?>index.php?manager=details&action=sales">View Details</a>
			</div>
		</div>
		...
		<div class="col-md-3 income">
			...
			<div class="more">
				<a href="<?php echo SITEROOTADMIN; ?>index.php?manager=details&action=profit">View Details</a>
			</div>
		</div>
