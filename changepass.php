...
{	
	$pass 		= $mydb->CleanString($_POST['password']);
...
<script>
          jQuery(document).ready(function(){
              ...
              jQuery("#adminchange").validationEngine();
            });
    </script> 
<form method="post"  id="adminchange" action="" enctype="multipart/form-data" name="f">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" class="FormTbl">
    ...
    <tr class="TitleBarB">
      ...
      <td><input type="password" id="password" name="new_pass" value="" class="inputBox form-control validate[required] text-input" /></td>
    </tr>
    <tr class="TitleBarA">
      <td  height="50"><strong>Confirm Password:</strong> </td>
      <td><input type="password" name="confirm_pass" value=""  class="inputBox  form-control validate[required,equals[password]] text-input"/></td>
    </tr>
    <tr>
