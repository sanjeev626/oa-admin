...
<form action="" method="post" name="tbl_conform_order" id="form1" class="cmxform">
  <table cellpadding="0" cellspacing="0" border="0" width="100%" class="FormTbl" style="font-size:12px;">
    <tr class="TitleBar">
      ...
      <td class="TtlBarHeading" style="width:50px;"><input name="btnAdd" type="button" value="Add order" class="button" onClick="window.location='<?php echo ADMINURLPATH;?>order_manage&new_order'" /></td>
    </tr>    
	...
	?>
    <tr>
      <td class="titleBarA" align="center" valign="top"><input name="eid[]" type="hidden" id="eid[]" value="<?php echo $order_val['id'];?>" />
        <?php echo ++$counter;?></td>
    ...
    <tr>
      ...
      <td class="titleBarB" align="center"><input type="number" name="refill" id="refill" class="inputbox" value="<?php echo $rasvalue['refill_day']?>"

						placeholder="days in number">
        <Br>
        <span>Example: 60 Days</span></td>
    </tr>
    <tr>
      <td class="titleBarB" align="center"><strong>Paid</strong>&nbsp;&nbsp;&nbsp;
        <input type="radio" name="payment" value="paid" id="payment" required></td>
      <td class="titleBarB" align="center"><strong>Due</strong>&nbsp;&nbsp;&nbsp;
        <input type="radio" name="payment" value="due" id="payment" ></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="titleBarA" align="center" valign="top"><input type="submit" name="btndeliver" id="btndeliver" value="Delivered " class="button" OnClick="return callDelivery('<?php echo $delivery_id;?>')" /></td>
      <td class="titleBarA" align="center" valign="top"><input type="submit" name="btndelay" id="btncancel" value="Cancel " class="button" OnClick="return callDeletesales('<?php echo $sales_id; ?>')" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
