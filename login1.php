...
if(isset($_POST['username']))
{
	...
	if($mydb->count_row($mydb->getQuery("*","tbl_admin","username = '".$getusername."'")) == 1)
	{
      ...
      //print_r($_SESSION);
			...
			$redirectUrl = SITEROOT.'dacadmin/index.php';
  ...
  <div id="form_wrapper" class="form_wrapper">
    ...
    <form method="post" action="" name="f1" class="login active" id="admin_login">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" class="adminLoginTbl" align="center">
        ...
        <tr>
          <td width="69%" style="padding:10px 0 20px 20px; vertical-align:bottom"><a href="#" rel="forgot_password" id="forgot_pass" class="forgot_linkform">Forgot Your Password?</a></td>
    ...
    <form method="post" action="" name="f2" style="display: none;" class="forgot_password" id="password_forgot">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" class="adminLoginTbl">
        <tr>
          <td style="padding:0"><table width="100%" cellpadding="0" cellspacing="0" border="0" class="adminLogForm">
              ...
              <tr>
                <td><input type="email" name="femail" id="femail" value="" class="inputBox"/></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="noacc" align="right" style="padding:10px 30px 10px 0"><a href="#" rel="login"  id="relogin" class="forgot linkform">Suddenly Remembered.Login Here</a></td>
        </tr>
      </table>
    </form>
  </div>
