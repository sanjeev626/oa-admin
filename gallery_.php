      ...
      <h3 align="center">Prescription</h3>
        <div class="row">
            ...
            <?php 
             ...
             ?>
         <div class="col-md-3">
            <img src="../<?php  echo $imagepath;?>/<?php echo $imagename;?>" alt="" width="250px;">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?php 
                              $result1=$mydb->getArray('image_name','tbl_image','id='.$resMember['id']);
                              ?>
                    <img src="<?php echo "http://onlineaushadhi.com/storage/app/".$result1['image_path'];?>" alt="" width="570px;">
                  </div>
