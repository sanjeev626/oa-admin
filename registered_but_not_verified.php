...
<script type="text/javascript">
 function callDelete(gid)
 {
	...
	{
	window.location='?manager=registered_only&did='+gid;
	}
 }
</script>
...
?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="FormTbl" style="font-size:12px;">
        <tr class="TitleBar">
            <td colspan="2" class="TtlBarHeading">Registered Only Users
                <div style="float:right"></div>
            </td>
            <td class="TtlBarHeading" colspan="6" width="100%"><input name="search" type="text" id="usersearch" Placeholder="Search by Name" class="button" style="width:250px;"/></td>
...
else
{
    ...
    //$mydb->getquery("*", "users", "register_from='" . $register_from . "'AND active=0 ORDER BY id DESC");

    $result = $mydb->getQuery('*', 'users', 'register_from="f0" AND active=0  ORDER BY id DESC limit ' . $start_from . ',' . $num_rec_per_page . '');
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="FormTbl" style="font-size:12px;">
        <tr class="TitleBar">
            <td colspan="2" class="TtlBarHeading">Registered Only Users (<?php echo $mydb->getCount('id', 'users','user_type="registered_only"');?>)
                <div style="float:right"></div>
            </td>
            <td class="TtlBarHeading" colspan="5" width="100%"><input name="search" type="text" id="usersearch" Placeholder="Search by Name" class="button" style="width:250px;"/></td>
        ...
        if ($count != 0) {
            ...
            <tr>
                <td width="2%" valign="top" class="titleBarB" align="center"><strong>S.N</strong></td>
                <td width="10%" class="titleBarB" align="center"><strong>Registered</strong></td>
                <td width="10%" class="titleBarB" align="center"><strong>Name</strong></td>
                <td width="20%" class="titleBarB" align="center"><strong>Email</strong></td>
                <td width="10%" class="titleBarB" align="center"><strong>Address</strong></td>
                <td width="15%" class="titleBarB" align="center"><strong>Contact Number</strong></td>
                 <td width="8%" class="titleBarB" align="center"><strong>Reference</strong></td>
            ...
            while ($rasMember = $mydb->fetch_array($result)) {
                ...
                <tr id="userinfo<?php echo $rasMember['id']; ?>">
                    ...
                    <td class="titleBarA" valign="top"><?php echo stripslashes($rasMember['register_date']); ?></td>
                    <td class="titleBarA" valign="top"><?php echo stripslashes($rasMember['name']); ?></td>
                    <td class="titleBarA" valign="top"><?php echo $rasMember['email']; ?></td>
                    <td class="titleBarA" valign="top"><?php echo $rasMember['address']; ?></td>
                    <td class="titleBarA" valign="top"><?php echo $rasMember['phone']; ?></td>
    ...
    if (isset($page)) {
        ...
        <nav style="text-align:center;">
            <ul class="pagination">
                <?php
                $rs_result = $mydb->getCount('id', 'users','register_from="f0"');
                ...
                else
                {
                    $j = $page - 1;
                    echo '<li >
                            <a href="' . ADMINURLPATH . 'registered_but_not_verified&page=' . $j . '" aria-label="Previous">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    if ($i <> $page) {
                        ...
                        echo '<li><a href ="' . ADMINURLPATH . 'registered_but_not_verified&page=' . $i . '" >' . $i . '</a></li>';
                    } else {
                        echo '<li >
                ...
                if ($page == $total_pages) {
                    ...
                    $j = $page + 1;
                    echo "<li>
                    <a href='" . ADMINURLPATH . 'registered_but_not_verified&page=' . $j . "' aria-label='Next'>
