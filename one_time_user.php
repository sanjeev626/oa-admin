...
<script type="text/javascript">
 function callDelete(gid)
 {
	...
	{
	window.location='?manager=one_time_user&did='+gid;
	}
 }
</script>
...
?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="FormTbl" style="font-size:12px;">
        <tr class="TitleBar">
            <td colspan="2" class="TtlBarHeading">One Time Users
...
else
{
    ...
    $result = $mydb->getQuery('*', 'users', 'user_type="one_time_user"  ORDER BY name limit ' . $start_from . ',' . $num_rec_per_page . '');
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="FormTbl" style="font-size:12px;">
        <tr class="TitleBar">
            <td colspan="2" class="TtlBarHeading">One Time Users (<?php echo $mydb->getCount('id', 'users','user_type="one_time_user"');?>)
                <div style="float:right"></div>
            </td>
        ...
        if ($count != 0) {
            ...
            <tr>
                ...
                <td width="10%" class="titleBarB" align="center"><strong>Name</strong></td>
                <td width="20%" class="titleBarB" align="center"><strong>Email</strong></td>
                <td width="8%" class="titleBarB" align="center"><strong>Address</strong></td>
                <td width="15%" class="titleBarB" align="center"><strong>Contact Number</strong></td>
    ...
    if (isset($page)) {
        ...
        <nav style="text-align:center;">
            <ul class="pagination">
                <?php
                $rs_result = $mydb->getCount('id', 'users','user_type="one_time_user"');
                ...
                else
                {
                    $j = $page - 1;
                    echo '<li >
                            <a href="' . ADMINURLPATH . 'one_time_user&page=' . $j . '" aria-label="Previous">
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    if ($i <> $page) {
                        ...
                        echo '<li><a href ="' . ADMINURLPATH . 'one_time_user&page=' . $i . '" >' . $i . '</a></li>';
                    } else {
                        echo '<li >
                ...
                if ($page == $total_pages) {
                    ...
                    $j = $page + 1;
                    echo "<li>
                    <a href='" . ADMINURLPATH . 'one_time_user&page=' . $j . "' aria-label='Next'>
