...
else
{
    ...
    $result = $mydb->getQuery('*', 'users', 'user_type="registered_only"  ORDER BY name limit ' . $start_from . ',' . $num_rec_per_page . '');
    ...
    if (isset($page)) {
        ...
        <nav style="text-align:center;">
            <ul class="pagination">
                <?php
                $rs_result = $mydb->getCount('id', 'users','user_type="registered_only"');
